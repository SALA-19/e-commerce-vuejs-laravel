<template>
    <div class="w-[200px] transition-all bg-amber-500 text-black py-4 px-2">
  ...
  <script setup>
    import {HomeIcon, UsersIcon, Bars4Icon, ChartBarIcon, UserGroupIcon} from '@heroicons/vue/24/outline'
  </script>
