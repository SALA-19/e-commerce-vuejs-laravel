  ...
  <div class="bg-white p-4 rounded-lg shadow">
    <div class="flex justify-between border-b-2 pb-3">
      <div class="flex items-center">
        <span class="whitespace-nowrap mr-3">Itens por Página</span>
      ...
      <tbody v-else>
          <tr v-for="product of products.data">
            ...
            <td class="border-b p-2">{{ product.price }}kz</td>
                ...
                <div class="px-1 py-1">
                  <MenuItem v-slot="{ active }">
                    ...
                    >
                      <PencilIcon
                      :class="[
                        active ? 'bg-amber-500 text-white' : 'text-gray-500',
                        'mr-2 h-5 w-5',
                      ]"
                        aria-hidden="true"
                      />
      ...
      <div v-if="!products.loading" class="flex justify-between items-center mt-5">
        <span>Mostrando de {{ products.from }} a {{ products.to }}</span>
